module github.com/dweomer/linode-controller-manager/tool/golangci-lint-kube-api-linter
...
// go mod edit -tool sigs.k8s.io/kube-api-linter/cmd/golangci-lint-kube-api-linter
