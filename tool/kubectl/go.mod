module github.com/dweomer/linode-controller-manager/tool/kubectl

// go get go@1.25.0 toolchain@go1.25

go 1.25.0

toolchain go1.25.10

// go mod edit -tool k8s.io/kubernetes/cmd/kubectl -replace k8s.io/kubectl=k8s.io/kubectl@v0.35 -require k8s.io/kubernetes@v1.35

tool k8s.io/kubernetes/cmd/kubectl

replace k8s.io/kubectl => k8s.io/kubectl v0.35.5
