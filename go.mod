module github.com/dweomer/linode-controller-manager
...
require (
	...
	k8s.io/apimachinery v0.35.5 // go mod edit -require k8s.io/apimachinery@v0.35
	sigs.k8s.io/controller-runtime v0.23.3 // go mod edit -require sigs.k8s.io/controller-runtime@v0.23
)
