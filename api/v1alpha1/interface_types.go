...
type InterfaceVPCIPv4Address struct {
	...
	// +k8s:optional
	NAT1To1Address *string `json:"nat1To1Address,omitzero" linode:"nat_1_1_address"`
}
...
type InterfaceLegacyIPv4 struct {
	...
	// 1:1 NAT public IPv4: a specific address or "any".
	// +k8s:optional
	NAT1To1 *string `json:"nat1To1,omitzero" linode:"nat_1_1"`
}
